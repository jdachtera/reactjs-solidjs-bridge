...
export type ReactToSolidBridgeContextType = {
  addSolidChild: (solidComponent: Component) => void
  removeSolidChild: (solidComponent: Component) => void
}

export const defaultReactToSolidBridgeContextValue: ReactToSolidBridgeContextType =
  {
    addSolidChild: () => {},
    removeSolidChild: () => {},
  }
